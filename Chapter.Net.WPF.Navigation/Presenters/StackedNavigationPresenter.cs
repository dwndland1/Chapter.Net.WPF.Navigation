// -----------------------------------------------------------------------------------------------------------------
// <copyright file="StackedNavigationPresenter.cs" company="dwndland">
...
public class StackedNavigationPresenter : NavigationPresenter
{
    ...
    /// </summary>
    /// <value>Default: StackingStrategy.Overlapping.</value>
    [DefaultValue(StackingStrategy.Overlapping)]
